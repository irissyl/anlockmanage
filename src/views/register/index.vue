        ...
        <div class="title">注册</div>
          ...
          <el-form-item>
            ...
            <router-link to="/login">
              <div  style="margin-top: 20px;font-size: 17px;color: #d7dee3;">登录</div>
            </router-link>
          </el-form-item>
        </el-form>
      </el-col>
...
<style lang="scss" scoped>
  .register-container {
    height: 100vh;
    background: url('~@/assets/login_images/bg.jpg') center center fixed
      no-repeat;
    ...
    .register-form {
      position: relative;
      max-width: 100%;
      margin: calc((100vh - 699px) / 2) 10% 10%;
      overflow: hidden;

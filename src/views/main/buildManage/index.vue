<template>
  <div class="build-container">
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="19" :xl="19">
        <div class="righttable1">
          <div class="btntotal21">
            ...
            <el-button icon="el-icon-files" type="primary" @click="uploads">批量导入</el-button>
          </div>
          <el-table ref="tableSort" height="700" v-loading="listLoading" style="width: 95%;margin:0 auto;" :data="lists" @selection-change="setSelectRows" @sort-change="tableSortChange">
            ...
            <el-table-column show-overflow-tooltip prop="" label="家具电器"></el-table-column>
            <el-table-column show-overflow-tooltip prop="" label="管理人（手机）"></el-table-column>
    ...
    <uploadfile ref="uploads"></uploadfile> 
  </div>
</template>
...
import Uploadfile from '../householdManage/components/uploadfile.vue'
export default {

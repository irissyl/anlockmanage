    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="10" :lg="4" :xl="4">
        <el-card class="all1" shadow="never">
          <el-tree class="left" :data="data" node-key="areaId" :default-expanded-keys="[1]" :props="defaultProps" @node-click="handleNodeClick">
            <span slot-scope="{ data }" class="custom-tree-node" :class="data.class">
              <span>
                <i :class="data.icon"></i>
                {{ data.areaName }}
              </span>
      ...
      <el-col :xs="24" :sm="24" :md="20" :lg="20" :xl="20">
        <el-card class="all1" shadow="never" style="height: 800px">
          <div class="grid-content bg-purple">
            <div class="right">
              <div class="btntotal">
                <el-button icon="el-icon-plus" type="primary" @click="handleyuanqu">
                  片区
                </el-button>
              ...
              <el-table ref="tableSort" border :data="list" :element-loading-text="elementLoadingText" :header-cell-style="{
                  'text-align': 'center',
                ...
                <el-table-column min-width="120px" show-overflow-tooltip prop="iotTag" label="门锁编号"></el-table-column>
                <el-table-column min-width="110px" show-overflow-tooltip prop="" label="锁状态"></el-table-column>
                <el-table-column min-width="110px" show-overflow-tooltip prop="" label="门状态"></el-table-column>
                <el-table-column min-width="110px" show-overflow-tooltip prop="" label="电表编号"></el-table-column>
                <el-table-column min-width="110px" show-overflow-tooltip prop="" label="水表编号"></el-table-column>
